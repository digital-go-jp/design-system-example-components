  ...
  render({ ...args }) {
    return (
      <fieldset className='flex flex-col gap-2 items-start'>
        ...
        <SeparatedDatePicker {...args}>
          <SeparatedDatePickerYear aria-describedby='date-picker-2-support-text' />
          <SeparatedDatePickerMonth aria-describedby='date-picker-2-support-text' />
          <SeparatedDatePickerDate aria-describedby='date-picker-2-support-text' />
        </SeparatedDatePicker>
      </fieldset>
    );
  },
  ...
  render({ ...args }) {
    return (
      <fieldset className='flex flex-col gap-2 items-start'>
        ...
        <SeparatedDatePicker {...args}>
          <SeparatedDatePickerYear
            aria-describedby='date-picker-4-support-text date-picker-2-error-text'
            aria-invalid={true}
          />
          <SeparatedDatePickerMonth
            defaultValue={10}
  ...
  render({ ...args }) {
    return (
      <fieldset className='flex flex-col gap-2 items-start'>
        ...
        <SupportText id='date-picker-5-support-text'>西暦、半角</SupportText>
        <SeparatedDatePicker {...args}>
          <SeparatedDatePickerYear
            aria-disabled={true}
